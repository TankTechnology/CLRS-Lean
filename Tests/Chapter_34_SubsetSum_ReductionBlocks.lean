...
#check Turing.SubsetSumReduction.choiceItemBlock_eq
#check Turing.SubsetSumReduction.choiceField_itemRun
#check Turing.SubsetSumReduction.choiceField_familyRun
#check Turing.SubsetSumReduction.choiceFieldCanonicalSteps_le
#check Turing.SubsetSumReduction.choiceBitFieldsRev_computableInPolyTime
#check Turing.SubsetSumReduction.choiceGeneratedFields_eq_items
#check Turing.SubsetSumReduction.choiceGeneratedFields_computableInPolyTime
#check Turing.SubsetSumReduction.generatedItemFields_eq
#check Turing.SubsetSumReduction.generatedItemFields_computableInPolyTime
#check Turing.SubsetSumReduction.generatedTypedRecord_eq
#check Turing.SubsetSumReduction.generatedTypedRecord_computableInPolyTime
#check Turing.SubsetSumReduction.generatedRawThreeCNFToSubsetSum_eq
#check Turing.SubsetSumReduction.rawThreeCNFToSubsetSum_computableInPolyTime
#check threeCNFSat_reducible_to_SUBSETSUM
#check SUBSETSUM_npHard
#check SUBSETSUM_npComplete
