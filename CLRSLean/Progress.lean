...
* Tracked reader-facing theorem entries: 1,412.
* Proved tracked theorem entries: 1,412.
...
35  35. Approximation Algorithms                                partial (edition coverage)           35.1; 35.2; 35.3                   13        2
```
