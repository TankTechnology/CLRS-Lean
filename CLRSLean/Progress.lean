...
* Tracked reader-facing theorem entries: 1,413.
* Proved tracked theorem entries: 1,413.
...
35  35. Approximation Algorithms                                partial (edition coverage)           35.1; 35.2; 35.3                   14        2
```
