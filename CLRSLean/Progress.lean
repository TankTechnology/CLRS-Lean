...
* Tracked reader-facing theorem entries: 1,418.
* Proved tracked theorem entries: 1,418.
...
35  35. Approximation Algorithms                                partial (edition coverage)           35.1; 35.2; 35.3; 35.4             19        1
```
