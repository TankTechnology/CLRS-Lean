...
Third-edition-numbered compatibility path for Johnson's algorithm for sparse graphs.  The canonical
fourth-edition source is
{lit}`CLRSLean.FourthEdition.Chapter_23.Section_23_3_Johnsons_Algorithm`;
