...
the total raw certificate checker, exact checker semantics, and quadratic
certificate bound.  The fixed checker TM2 and NP-hard gadget reduction are
separate closure layers.
-/
