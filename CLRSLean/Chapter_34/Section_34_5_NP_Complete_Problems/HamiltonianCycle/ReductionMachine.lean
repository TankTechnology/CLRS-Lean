...
successive incidence-chain edge.  A second fixed controller extracts the two
gadget ports at the ends of every nonempty incidence row.  Repeating and
formatting those endpoints, followed by guarded total composition, remains.
-/
