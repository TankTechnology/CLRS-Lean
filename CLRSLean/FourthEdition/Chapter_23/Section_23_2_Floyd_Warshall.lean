...
/-!
# 23.2. The Floyd-Warshall algorithm — correctness proof

## Proven

* `Through` predicate and walk-splitting lemmas (`through_subwalk_left`,
  `through_subwalk_right`) — **Lemma 23.7** core machinery.
...
diagonal entries of the final distance matrix.  CLRS Theorem 23.3 states:
