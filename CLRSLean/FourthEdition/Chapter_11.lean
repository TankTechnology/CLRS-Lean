...
under {lit}`CLRSLean.FourthEdition.Chapter_11`.  Declarations retain the
{lit}`CLRS.Chapter11` namespace; the legacy import {lit}`CLRSLean.Chapter_11`
and its {lit}`Section_11_*` modules forward to these sources during the
