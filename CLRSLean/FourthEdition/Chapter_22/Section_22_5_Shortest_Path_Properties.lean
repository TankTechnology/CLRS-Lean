...
The subpath property (Lemma 22.10), the convergence/path-relaxation lemmas
(Lemmas 22.14-22.15), the predecessor-subgraph property (Lemma 22.16), and the
Dijkstra-correctness reformulation (Theorem 22.17) are not restated here;
Dijkstra correctness is already proved in Section 22.3, and
