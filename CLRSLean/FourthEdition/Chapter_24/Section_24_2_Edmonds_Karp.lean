...
(CLRS Lemma 24.7) for augmentation along a shortest residual path.
...
* [The O(VE²) work analysis](CLRSLean/FourthEdition/Chapter_24/Section_24_2_Edmonds_Karp/S3_WorkAnalysis/)
* [Executable residual BFS](CLRSLean/FourthEdition/Chapter_24/Section_24_2_Edmonds_Karp/S4_ExecutableBFS/)
-/
...
This is the path-lifting core of Lemma 24.7.  An edge that already existed uses
...
/-- **CLRS Lemma 24.7 (monotonic residual distance).**  Augmenting along a
