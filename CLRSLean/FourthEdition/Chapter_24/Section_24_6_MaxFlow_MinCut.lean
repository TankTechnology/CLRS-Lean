...
This file proves the complete Max-Flow Min-Cut equivalence (CLRS Theorem 24.6).
...
/-- If the value of a flow equals the capacity of some cut, the flow is maximal.
    This is the easy direction of Theorem 24.6. -/
...
/-- **Max-Flow Min-Cut Theorem (CLRS Theorem 24.6).** A feasible flow is
