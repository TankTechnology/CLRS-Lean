...
/-- Executable Kruskal state: the Chapter 19 machine, selected edges, and
...
/-- The Chapter 19 union charge covers the preceding equivalence query: both
...
/-- One executable cycle query followed by the Chapter 19 union operation.
...
/-- The charged Kruskal work is twice the Chapter 19 union trace: one charge
