...
/-! # Section 20.3 - Depth-First Search
...
model are proved in the companion {lit}`Section_20_3_DFS.S1_WhitePath` and
{lit}`Section_20_3_DFS.S2_Intervals` modules.  The latter also proves the timestamp
