...
* [Section 4.7 — Akra–Bazzi recurrences](CLRSLean/FourthEdition/Chapter_04/Section_04_7_Akra_Bazzi/):
  the recurrence hypotheses, the root equation, and the single-branch corollary
  recovering the master theorem.
...
the polynomial-smoothness hypothesis remain recorded gaps (see §4.7).
