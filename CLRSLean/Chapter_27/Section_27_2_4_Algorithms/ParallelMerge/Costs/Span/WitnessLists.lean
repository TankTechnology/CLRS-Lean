...
/-!
# 27.3. P-MERGE Span — Interleaved Witness Lists (legacy compatibility path)

Third-edition-numbered compatibility path for this module.  The canonical
fourth-edition source is
{lit}`CLRSLean.FourthEdition.Chapter_26.Section_26_2_4_Algorithms.ParallelMerge.Costs.Span.WitnessLists`;
