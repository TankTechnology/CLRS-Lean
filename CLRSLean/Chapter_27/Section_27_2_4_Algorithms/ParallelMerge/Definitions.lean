...
This module starts the executable merge development with the lower-bound
binary search used by P-MERGE.  The search works over half-open index ranges
and records one unit of work and span for every inspected element.
-/
