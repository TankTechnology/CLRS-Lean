...
The imported modules provide exact power-of-two work/span recurrences,
P-MATMUL all-input upper bounds, and monotonicity, adjacent-power sandwich,
and all-input `Θ` results for P-MERGE, P-MERGE-SORT, and retained Strassen.
