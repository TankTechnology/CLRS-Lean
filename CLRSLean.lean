...
* Chapter 17 - Amortized Analysis: finite-prefix aggregate, accounting, and
  ...
  direction, positive insertion/deletion count/capacity wrappers, post-state
  capacity, post-transition potential, concrete
...
* Chapter 19 - Fibonacci Heaps: abstract finite-set heap model with
  ...
  remaining/delete minimum nonempty-result wrappers,
