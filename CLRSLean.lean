...
* Chapter 8 - Sorting in Linear Time: stable counting-sort bucket correctness,
  ...
  stable digit passes, and deterministic bucket-sort correctness.
...
* 4.6 Proof of the master theorem: `partial`.
  ...
  `CLRS.Chapter04.criticalPowerScale`, and
  `CLRS.Chapter04.allInput_bigTheta_of_criticalPowerScale`.  Remaining target:
  analytic comparison scales and final floor/ceiling Master cases.
