...
> 1,621 / 1,621 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟢 complete | 53 / 53 | — |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1621 of 1621 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
