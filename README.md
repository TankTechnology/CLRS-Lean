...
> 1,330 / 1,330 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 25 | Matchings in Bipartite Graphs | 🟠 partial coverage | 4 / 4 | Section 25.2 stable-marriage problem and Section 25.3… |
...
**Total: 1330 of 1330 selected theorem entries have kernel-checked proofs across 31 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
