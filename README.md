...
> 32 of 35 chapters have canonical represented content.
> 1,384 / 1,384 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
**Total: 1384 of 1384 selected theorem entries have kernel-checked proofs across 32 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
