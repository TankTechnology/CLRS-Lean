...
> 1,329 / 1,329 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 1 / 1 | Sections 34.2-34.5 (verification/NP, reducibility, proofs,… |
| 35 | Approximation Algorithms | ⬜ not started | 0 / 0 | Whole fourth-edition chapter theorem inventory and… |

**Total: 1329 of 1329 selected theorem entries have kernel-checked proofs across 31 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
