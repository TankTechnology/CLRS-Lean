...
> 30 of 35 chapters have canonical represented content.
> 1,372 proved source-inventory entries are mapped into the fourth-edition ledger.
> 421 additional entries from three wholly excluded legacy chapters remain available
> through the online-material compatibility catalog. These facade-level counts are not
> a count of distinct fourth-edition textbook obligations; moved subsections are pending declaration-level remapping.
<!-- END edition-summary -->
...
|---:|-------|--------|-------:|----------------|
| 1 | The Role of Algorithms in Computing | ⚪ guide | 0 | — |
| 2 | Getting Started | 🟢 complete | 7 | — |
| 3 | Characterizing Running Times | 🟠 partial | 47 | Section 3.1 (O-notation Ω-notation and Θ-notation): partial;… |
| 4 | Divide-and-Conquer | 🟠 partial | 96 | Section 4.1 (Multiplying square matrices): partial; Section… |
| 5 | Probabilistic Analysis and Randomized Algorithms | 🟡 sections | 25 | — |
| 6 | Heapsort | 🟢 complete | 78 | — |
| 7 | Quicksort | 🟠 partial | 30 | Section 7.4 (Analysis of quicksort): partial |
| 8 | Sorting in Linear Time | 🟢 correctness | 36 | — |
| 9 | Medians and Order Statistics | 🟢 complete | 72 | — |
| 10 | Elementary Data Structures | 🟠 partial | 12 | Section 10.1 (Simple array-based data structures): partial |
| 11 | Hash Tables | 🟠 partial | 51 | Section 11.5 (Practical considerations): not-started |
| 12 | Binary Search Trees | 🟢 correctness | 40 | — |
| 13 | Red-Black Trees | 🟠 partial | 39 | Section 13.3 (Insertion): partial; Section 13.4 (Deletion):… |
| 14 | Dynamic Programming | 🟠 partial | 76 | Section 14.3 (Elements of dynamic programming): partial |
| 15 | Greedy Algorithms | 🟠 partial | 32 | Section 15.4 (Offline caching): not-started |
| 16 | Amortized Analysis | 🟡 sections | 66 | — |
| 17 | Augmenting Data Structures | 🟠 partial | 77 | Section 17.2 (How to augment a data structure): partial |
| 18 | B-Trees | 🟢 correctness | 134 | — |
| 19 | Data Structures for Disjoint Sets | 🟢 complete | 84 | — |
| 20 | Elementary Graph Algorithms | 🟢 correctness | 47 | — |
| 21 | Minimum Spanning Trees | 🟢 correctness | 52 | — |
| 22 | Single-Source Shortest Paths | 🟡 sections | 27 | — |
| 23 | All-Pairs Shortest Paths | 🟢 correctness | 24 | — |
| 24 | Maximum Flow | 🟢 complete | 18 | — |
| 25 | Matchings in Bipartite Graphs | ⬜ not started | 0 | Whole fourth-edition chapter theorem inventory and… |
| 26 | Parallel Algorithms | 🟢 complete | 95 | — |
| 27 | Online Algorithms | ⬜ not started | 0 | Whole fourth-edition chapter theorem inventory and… |
| 28 | Matrix Operations | 🟢 complete | 9 | — |
| 29 | Linear Programming | 🟠 partial | 17 | Section 29.1 (Linear programming formulations and… |
| 30 | Polynomials and the FFT | 🟢 complete | 46 | — |
| 31 | Number-Theoretic Algorithms | 🟡 sections | 16 | — |
| 32 | String Matching | 🟠 partial | 19 | Section 32.2 (The Rabin–Karp algorithm): not-started;… |
| 33 | Machine-Learning Algorithms | ⬜ not started | 0 | Whole fourth-edition chapter theorem inventory and… |
| 34 | NP-Completeness | ⬜ not started | 0 | Whole fourth-edition chapter theorem inventory and… |
| 35 | Approximation Algorithms | ⬜ not started | 0 | Whole fourth-edition chapter theorem inventory and… |

**Total: 1372 kernel-checked theorem entries across 30 represented fourth-edition chapters** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
