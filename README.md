...
> 1,598 / 1,598 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 38 / 38 | Section 34.5 raw VERTEX-COVER language and machine-level… |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1598 of 1598 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
