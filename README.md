...
> 1,351 / 1,351 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 3 | Characterizing Running Times | 🟢 complete | 57 / 57 | — |
...
**Total: 1351 of 1351 selected theorem entries have kernel-checked proofs across 31 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
