...
> 1,606 / 1,606 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 46 / 46 | Section 34.5 is complete at the selected typed textbook… |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1606 of 1606 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
