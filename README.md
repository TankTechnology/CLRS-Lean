...
| 27 | Multithreaded Algorithms | 🟠 partial | 82 | Global executable P-MERGE linear-work and quadratic-log-span… |
...
**Total: 1692 kernel-checked theorems across Chapters 1–33** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
