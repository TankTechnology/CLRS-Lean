...
| 27 | Multithreaded Algorithms | 🟠 partial | 31 | Explicit ready-strand CompDAG execution producing… |
...
**Total: 1641 kernel-checked theorems across Chapters 1–33** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
