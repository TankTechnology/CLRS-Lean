...
> 1,584 / 1,584 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 24 / 24 | The concrete polynomial-time TM2 implementation of the… |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1584 of 1584 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
