...
> 1,599 / 1,599 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 39 / 39 | Section 34.5 fixed polynomial-time VERTEX-COVER… |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1599 of 1599 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
