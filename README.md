...
> 1,326 proved source-inventory entries are mapped into the fourth-edition ledger.
> 467 additional entries remain available through the
...
| 4 | Divide-and-Conquer | 🟠 partial | 82 | Section 4.1 (Multiplying square matrices): partial; Section… |
...
| 11 | Hash Tables | 🟠 partial | 48 | Section 11.5 (Practical considerations): not-started |
...
| 15 | Greedy Algorithms | 🟠 partial | 23 | Section 15.4 (Offline caching): not-started |
...
| 29 | Linear Programming | 🟠 partial | 10 | Section 29.1 (Linear programming formulations and… |
| 30 | Polynomials and the FFT | 🟢 complete | 34 | — |
| 31 | Number-Theoretic Algorithms | 🟡 sections | 15 | — |
...
**Total: 1326 kernel-checked theorem entries across 30 represented fourth-edition chapters** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
