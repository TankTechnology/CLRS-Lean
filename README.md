...
> 1,424 / 1,424 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 35 | Approximation Algorithms | 🟢 complete | 25 / 25 | — |

**Total: 1424 of 1424 selected theorem entries have kernel-checked proofs across 34 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
