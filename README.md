...
Algorithms*, fourth edition, in Lean 4. The book website connects chapter
guides to executable definitions, correctness proofs, invariants, and cost
bounds.

**September 8 review and repairs:** the inventory records 1,689 proved
selected entries across 35 chapter guides. The
[chapter audit](docs/audits/2026-09-08-chapter-review/index.md) identified interface,
implementation, and execution-cost issues; the
[repair record](docs/plans/2026-09-08-chapter-repairs/index.md) links the fixes,
verification, and remaining model boundaries. This is a proof-library milestone,
not a claim that every textbook statement or implementation has been formalized.
See the [scope](docs/scope.md).
...
> 1,689 / 1,689 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| Read | Verify | Contribute |
| --- | --- | --- |
| [Website](https://tanktechnology.github.io/CLRS-Lean/) · [Chapters 1–35](https://tanktechnology.github.io/CLRS-Lean/CLRSLean/FourthEdition/) | [Progress Dashboard](https://tanktechnology.github.io/CLRS-Lean/CLRSLean/Progress/) · [Proof Status](https://tanktechnology.github.io/CLRS-Lean/CLRSLean/Status/) | [Contributor Guide](https://tanktechnology.github.io/CLRS-Lean/CLRSLean/Workflow/) · [Documentation](docs/index.md) |

The public project name is **CLRS-Lean**; Lean imports use `CLRSLean`.
New code starts from `CLRSLean.FourthEdition.Chapter_NN`.
...
The generated table below preserves the current ledger; its completion labels
have not yet been reclassified against the September 8 semantic findings.
...
| 2 | Getting Started | 🟢 complete | 20 / 20 | — |
| 3 | Characterizing Running Times | 🟢 complete | 71 / 71 | — |
| 4 | Divide-and-Conquer | 🟢 complete | 104 / 104 | — |
| 5 | Probabilistic Analysis and Randomized Algorithms | 🟢 complete | 26 / 26 | — |
| 6 | Heapsort | 🟢 complete | 85 / 85 | — |
...
| 11 | Hash Tables | 🟢 complete | 62 / 62 | — |
| 12 | Binary Search Trees | 🟢 complete | 44 / 44 | — |
| 13 | Red-Black Trees | 🟢 complete | 40 / 40 | — |
| 14 | Dynamic Programming | 🟢 complete | 90 / 90 | — |
| 15 | Greedy Algorithms | 🟢 complete | 40 / 40 | — |
...
| 20 | Elementary Graph Algorithms | 🟢 complete | 50 / 50 | — |
...
| 28 | Matrix Operations | 🟢 complete | 13 / 13 | — |
...
| 34 | NP-Completeness | 🟢 complete | 59 / 59 | — |
| 35 | Approximation Algorithms | 🟢 complete | 13 / 13 | — |

**Total: 1689 of 1689 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
...
| What appears on the website? | `src/CLRSLean.lean`, chapter guides, and `literate.toml` |
...
To build and preview the book website, follow the
[site runbook](docs/site-architecture.md#local-preview). It documents the shared
local and GitHub Pages pipeline, rendering checks, and recovery steps.
