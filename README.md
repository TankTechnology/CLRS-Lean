...
> 1,432 / 1,432 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 32 | String Matching | 🟠 partial coverage | 29 / 29 | Section 32.3 (String matching with finite automata):… |
...
**Total: 1432 of 1432 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
