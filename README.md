...
> 1,591 / 1,591 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 34 | NP-Completeness | 🟠 partial coverage | 31 / 31 | General graph-plus-k CLIQUE and Section 34.5 (NP-complete… |
| 35 | Approximation Algorithms | 🟢 complete | 10 / 10 | — |

**Total: 1591 of 1591 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
