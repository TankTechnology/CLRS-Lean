...
> 1,358 / 1,358 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 25 | Matchings in Bipartite Graphs | 🟠 partial coverage | 8 / 8 | Section 25.3 Hungarian algorithm remains not-started;… |
...
**Total: 1358 of 1358 selected theorem entries have kernel-checked proofs across 31 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
