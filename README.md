...
> 1,422 / 1,422 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
> This selected inventory is not a claim of complete fourth-edition section coverage.
> 464 additional entries remain available through the
...
| 17 | Augmenting Data Structures | 🟡 sections | 77 / 77 | Section 17.1: OS-RANK combined invariants and logarithmic… |
...
| 29 | Linear Programming | 🟡 sections | 10 / 10 | Section 29.1: general-form normalization and canonical… |
| 30 | Polynomials and the FFT | 🟢 complete | 34 / 34 | — |
| 31 | Number-Theoretic Algorithms | 🟡 sections | 17 / 17 | — |
| 32 | String Matching | 🟡 sections | 19 / 19 | Section 32.2 (The Rabin–Karp algorithm): not-started;… |
...
**Total: 1422 of 1422 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
