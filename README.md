...
> 1,418 / 1,418 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 35 | Approximation Algorithms | 🟠 partial coverage | 19 / 19 | Section 35.5 (the subset-sum FPTAS) is not represented |

**Total: 1418 of 1418 selected theorem entries have kernel-checked proofs across 34 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
