...
> 33 of 35 chapters have canonical represented content.
> 1,387 / 1,387 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 25 | Matchings in Bipartite Graphs | 🟠 partial coverage | 10 / 10 | Section 25.3 Hungarian algorithm remains not-started |
| 26 | Parallel Algorithms | 🟢 complete | 95 / 95 | — |
| 27 | Online Algorithms | 🟠 partial coverage | 3 / 3 | Sections 27.2 (Maintaining a search list) and 27.3 (Online… |
...
**Total: 1387 of 1387 selected theorem entries have kernel-checked proofs across 33 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
