...
> 1,681 / 1,681 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 15 | Greedy Algorithms | 🟢 complete | 37 / 37 | — |
...
**Total: 1681 of 1681 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
