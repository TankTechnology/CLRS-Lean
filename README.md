...
> 1,412 / 1,412 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 35 | Approximation Algorithms | 🟠 partial coverage | 13 / 13 | Sections 35.4-35.5 (randomized rounding and the subset-sum… |

**Total: 1412 of 1412 selected theorem entries have kernel-checked proofs across 34 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
