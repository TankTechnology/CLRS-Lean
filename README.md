...
> 1,445 / 1,445 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 32 | String Matching | 🟠 partial coverage | 42 / 42 | Section 32.4 (The Knuth-Morris-Pratt algorithm):… |
...
**Total: 1445 of 1445 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
