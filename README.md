...
> 1,482 / 1,482 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 32 | String Matching | 🟠 partial coverage | 48 / 48 | Section 32.5 (Suffix arrays): not-started |
...
**Total: 1482 of 1482 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
