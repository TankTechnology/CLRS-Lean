...
| 27 | Multithreaded Algorithms | 🟠 partial | 47 | All-input Theta-bounds for the merge-based costs; executable… |
...
**Total: 1657 kernel-checked theorems across Chapters 1–33** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
