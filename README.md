...
> 1,410 / 1,410 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 35 | Approximation Algorithms | 🟠 partial coverage | 11 / 11 | Sections 35.3-35.5 (set cover, randomized rounding, and the… |

**Total: 1410 of 1410 selected theorem entries have kernel-checked proofs across 34 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
