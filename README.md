...
> 1,658 / 1,658 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
| 2 | Getting Started | 🟢 complete | 17 / 17 | — |
...
**Total: 1658 of 1658 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
