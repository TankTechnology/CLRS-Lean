...
| 27 | Multithreaded Algorithms | 🟠 partial | 84 | Global executable P-MERGE quadratic-log-span bound;… |
...
**Total: 1694 kernel-checked theorems across Chapters 1–33** (no `sorry`/`admit`/axiom on `main`).
<!-- END progress-table -->
