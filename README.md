...
> 1,579 / 1,579 selected source-inventory entries are proved and mapped into the fourth-edition ledger.
...
**Total: 1579 of 1579 selected theorem entries have kernel-checked proofs across 35 represented fourth-edition chapters** (no `sorry`/`admit`/project axiom on `main`). This does not by itself claim complete fourth-edition coverage.
<!-- END progress-table -->
