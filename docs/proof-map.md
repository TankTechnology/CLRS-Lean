...
- Proof pattern: finite-set key semantics, normalized root/mark counters,
  ...
  Chapter 17 potential-method instantiation, direct operation-key membership
  corollaries, Fibonacci lower-bound recurrence
...
insert/union/extract-min/decrease-key/delete membership facts and operation-key
membership corollaries.  The standard
