...
| Section 4.1 - Maximum subarray | `CLRSLean/Chapter_04/Section_04_1_Maximum_Subarray.lean` | `proved` for the exhaustive-search specification plus crossing/combine interface | `CLRS.Chapter04.mem_nonemptySubarrays_iff`, `CLRS.Chapter04.mem_crossingSubarrays_iff`, `CLRS.Chapter04.maxCrossingSubarray_correct`, `CLRS.Chapter04.subarray_append_left_or_right_or_crossing`, `CLRS.Chapter04.subarray_append_optimal_of_cases`, `CLRS.Chapter04.maxSubarrayDivideStep_correct`, `CLRS.Chapter04.maxSubarray_correct` |
