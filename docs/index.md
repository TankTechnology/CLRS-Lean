...
| Section 9.3 - Deterministic selection | `CLRSLean/Chapter_09/Section_09_3_Deterministic_Select.lean` | `proved` for pivot-parametric deterministic SELECT correctness and grouped median-of-medians split-count bounds | `CLRS.Chapter09.selectWithPivot?_mem`, `CLRS.Chapter09.selectWithPivot?_rankCorrect`, `CLRS.Chapter09.selectWithPivot?_correct`, `CLRS.Chapter09.medianOfFive?_certificate`, `CLRS.Chapter09.medianGroupCertificates_leCount_lower_bound`, `CLRS.Chapter09.medianGroupCertificates_geCount_lower_bound`, `CLRS.Chapter09.medianGroupCertificates_selectPivot_split_counts`, `CLRS.Chapter09.deterministicSelect?_mem`, `CLRS.Chapter09.deterministicSelect?_rankCorrect`, `CLRS.Chapter09.deterministicSelect?_correct` |
