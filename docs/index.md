...
| Section 4.6 - Proof of the master theorem | `CLRSLean/Chapter_04/Section_04_6_Master_Theorem_All_Input.lean` | `partial` with all-input transfer bridge proved | `CLRS.Chapter04.allInput_bigO_of_power_upper_sandwich`, `CLRS.Chapter04.allInput_bigOmega_of_power_lower_sandwich`, `CLRS.Chapter04.allInput_bigTheta_of_power_sandwich` |
...
| Section 8.2 - Counting sort | `CLRSLean/Chapter_08/Section_08_2_Counting_Sort.lean` | `proved` for the stable bucket specification | `CLRS.Chapter08.countingSortBy_ordered`, `CLRS.Chapter08.countingSortBy_bucket_eq`, `CLRS.Chapter08.countingSortBy_mem_iff`, `CLRS.Chapter08.countingSortBy_correct` |
| Section 8.3 - Radix sort | `CLRSLean/Chapter_08/Section_08_3_Radix_Sort.lean` | `proved` for the abstract stable digit-pass model | `CLRS.Chapter08.radixPass_orderedRel`, `CLRS.Chapter08.radixSortBy_ordered`, `CLRS.Chapter08.radixSortBy_mem_iff`, `CLRS.Chapter08.radixSortBy_correct` |
| Section 9.2 - Selection by rank | `CLRSLean/Chapter_09/Section_09_2_Select_By_Rank.lean` | `proved` for the specification selector | `CLRS.Chapter09.selectByRank?_mem`, `CLRS.Chapter09.selectByRank?_rankCorrect`, `CLRS.Chapter09.selectByRank?_correct` |
