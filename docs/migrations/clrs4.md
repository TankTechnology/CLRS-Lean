...
| Chapter 34, NP-Completeness | `CLRSLean.Chapter_34` (facade §34.1--34.3, partial §34.4) | Sections 34.1--34.3 reuse the legacy source through a compatibility facade; §34.4 includes the concrete Cook--Levin reduction, `GeneralCircuitSAT` NP-completeness, and an honest general graph-plus-`k` CLIQUE language with NP membership and a concrete 3-CNF-SAT reduction. The concrete GeneralCircuitSAT-to-SAT compiler needed for the full CLIQUE NP-hardness chain remains; §34.5 is not-started. |
