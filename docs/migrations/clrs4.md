...
| Chapter 34, NP-Completeness | `CLRSLean.Chapter_34` (facade §34.1--34.3, partial §34.4) | Sections 34.1--34.3 reuse the legacy source through a compatibility facade; §34.4 now includes the concrete Cook--Levin polynomial-time reduction and `GeneralCircuitSAT` NP-completeness, but remains partial until general graph-plus-`k` CLIQUE is represented; §34.5 is not-started. |
