...
| --- | --- | --- |
| 0 | Chapter 22 | Complete the remaining textbook-facing DFS layer: parenthesis theorem, edge classification, and DFS-based topological sort.  The white-path theorem and full Kosaraju SCC correctness are proved; BFS shortest-path distance lemmas remain secondary. |
