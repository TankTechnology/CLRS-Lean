...
| --- | --- | --- |
| 0 | Chapter 22 | Complete the remaining textbook-facing DFS layer: ancestor/interval characterization, edge classification, and DFS-based topological sort.  The white-path theorem, timestamp parenthesis theorem, and full Kosaraju SCC correctness are proved; BFS shortest-path distance lemmas remain secondary. |
