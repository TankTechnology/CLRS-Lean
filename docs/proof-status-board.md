...
| --- | --- | --- |
| 0 | Chapter 22 | Complete DFS (parenthesis theorem, white-path theorem, edge classification), then topological sort and strongly connected components on the Section 22.1 graph model; BFS completeness and shortest-path distances remain secondary. |
