...
/-!
# CLRS Section 34.4 - Finite-control dispatch facade

Stable import facade for the finite-label dispatcher, its literal recursive
gate trace, and its exact complete-row stuttering semantics.
-/
