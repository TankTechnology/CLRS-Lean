...
/-!
# 30.3 FFT 3. Iterative Correctness (legacy compatibility path)

Third-edition-numbered compatibility path for this module.  The canonical
fourth-edition source is
{lit}`CLRSLean.FourthEdition.Chapter_30.Section_30_3_Efficient_FFT_Implementations.IterativeFFT.Correctness`;
