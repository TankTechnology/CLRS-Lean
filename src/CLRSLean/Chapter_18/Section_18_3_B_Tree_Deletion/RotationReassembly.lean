...
/-!
# Section 18.3 - Deletion: RotationReassembly (legacy compatibility path)

Third-edition-numbered compatibility path for this B-tree development.  The
canonical fourth-edition source is
{lit}`CLRSLean.FourthEdition.Chapter_18.Section_18_3_B_Tree_Deletion.RotationReassembly`;
