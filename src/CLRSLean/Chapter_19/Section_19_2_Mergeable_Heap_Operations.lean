...
Section 19.3 adds duplicate-safe occurrence paths, arbitrary-node cascading
cuts, executable decrease/delete, and certified operation/trace costs.
Circular doubly linked lists and mutable pointer allocation remain lower-level
refinements of this persistent forest model.
-/
