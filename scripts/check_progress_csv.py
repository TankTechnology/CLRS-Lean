...
def render_dashboard(rows: list[dict[str, str]]) -> str:
    ...
    lines: list[str] = [
        ...
        "# Progress Dashboard",
        "",
        f"CLRS-Lean represents all {len(rows)} fourth-edition chapters and proves",
        f"all {proved:,} of its {tracked:,} selected reader-facing theorem entries.",
    ...
    lines.extend(
        [
            ...
            f"2. Regenerate this page with {lit('uv run python scripts/check_progress_csv.py --write-dashboard')}.",
